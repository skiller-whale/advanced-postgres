...
|
|    * Add a line of code between the two SELECTs which would change the number
|      of rows returned by SELECT * FROM categories; but would not change the
|      number of rows returned by get_raw_page.
|
*/ -----------------------------------------------------------------------------
